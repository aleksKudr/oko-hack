(function($) {
  ...
  jQuery(document).ready(function(){
    ...
    $("#TitleDate").html(new Date().toLocaleDateString('ru', { day:"numeric", year:"numeric", month:"long"}))
    $("#TitleMonth").html((new Date(2021,10) ).toLocaleDateString('ru', { year:"numeric", month:"long"}))
